  ...
  try {
    switch (true) {
      ...
      case !/^\d+$/.test(dividend): // Check if dividend is numeric
        result.innerText =
          "Division not performed. Dividend must be a valid whole number. Try again";
        crash();
      ...
      case !/^\d+$/.test(divider): // Check if divider is numeric
        result.innerText =
          "Division not performed. Divider must be a valid whole number. Try again";
        crash();
        console.error(new Error("Invalid parameter entered!"));
        errors = true;
        break;
      ...
      case divider === "0":
        result.innerText =
          "Division not performed. Invalid whole number provided. Try again";
        errors = true;
